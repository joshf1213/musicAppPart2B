...
namespace MusicFall2016.Migrations
{
    ...
    [Migration("20161113184847_PlaylistNameRequired")]
    partial class PlaylistNameRequired
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("MusicFall2016.Models.AppUser", b =>
                {
                    b.Property<string>("Id");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MusicFall2016.Models.AppUser")
                        .WithMany("Claims")
